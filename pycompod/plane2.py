...
# X_scaled = scaler.fit_transform(X)
#
# # Set class weights to prioritize occupied points
# class_weights = {0: 1, 1: 10}  # Empty points have weight 1, occupied points have weight 10
#
# # Fit the LinearSVC model with class weights
# svc = LinearSVC(class_weight=class_weights,max_iter=100000)
# svc.fit(X_scaled, y)
#
