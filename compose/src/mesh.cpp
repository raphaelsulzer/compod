...
//template <typename Kernel>
//void SMesh<Kernel>::_color_mesh_by_region(){

//    auto fcolor = _mesh.add_property_map<typename Mesh::Face_index, CGAL::Color>("f:color",CGAL::white()).first;
...
//#include <random>
//template <typename Kernel>
//void SMesh<Kernel>::_color_mesh_boundary(Mesh& mesh, int seed){


//    typename Mesh::Property_map<typename Mesh::Vertex_index, typename CGAL::Color>
//        color_map = mesh.add_property_map<typename Mesh::Vertex_index, typename CGAL::Color>("v:color", typename CGAL::white()).first;
...
//template <typename Kernel>
//int SMesh<Kernel>::soup_to_mesh_no_repair(){
...
//template <typename Kernel>
//void SMesh<Kernel>::_get_corner_vertices(){
...
//template <typename Kernel>
//void SMesh<Kernel>::_save_region_mesh(const vector<Mesh::Face_index>& region,const string name){
...
//template <typename Kernel>
//CF::CF(SMesh<Kernel>& smesh) : _smesh(smesh)
//{};
...
//template <typename Kernel>
//int SMesh<Kernel>::remesh_planar_regions(const bool triangulate, const bool simplify_edges){
